...
mean_ave_df = ny_noaa_df %>% 
  ...
  distinct(id, month, ave_max) 
  
plot_names <- c("01" = "Januarary", "07" = "July")

mean_ave_df%>%
  ggplot(aes(x = id, y = ave_max)) + 
...
There are a few outliers of mean temperature of 8 years in some positions in Januarary and July. Four stations in Januarary are outliers while three stations are outliers in July. The median mean temperature of Januarary lies around 0 degrees while the median mean temperature of July lies around 27 degress. 
